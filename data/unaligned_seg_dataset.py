import sys
import os.path
from data.base_dataset import BaseDataset, get_transform, get_transform_for_seg
...
class UnalignedSegDataset(BaseDataset):
    ...
    def initialize(self, opt):
        ...
        self.transform_for_seg = get_transform_for_seg(opt)

    def fixed_transform(self, image, seed, seg=False):
        random.seed(seed)
        if seg:
            return self.transform_for_seg(image)
    ...
    def read_segs(self, seg_path, seed):
        ...
        for i in range(self.max_instances):
            ...
            if os.path.isfile(path):
                ...
                seg = self.fixed_transform(seg, seed, seg=True)
                segs.append(seg)
            else:
